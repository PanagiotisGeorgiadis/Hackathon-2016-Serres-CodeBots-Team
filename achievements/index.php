		...
		<div class="container">
			...
			<div class="row high_prio_achievements_container">
				...
				<div class="col-xs-11 achievement_text_container" >
					<h2 class="achievement_text">This is a high Prio achievement</h2>
				</div>
			</div>
	...
	<section id="medium_priority_achievements">
		...
		<div class="container">
			...
			<div class="row medium_prio_achievements_container">
				...
				<div class="col-xs-11 achievement_text_container" >
					<h2 class="achievement_text">This is a medium Prio achievement</h2>
				</div>
			</div>
	...
	<section id="low_priority_achievements">
		...
		<div class="container">
			...
			<div class="row medium_prio_achievements_container">
					...
					<div class="col-xs-11 achievement_text_container" >
						<h2 class="achievement_text">This is a low Prio achievement</h2>
					</div>
				</div>
